  ...
  useEffect(()=>{
    ...
    return(
        ...
        <Routes>
          ...
          <Route key={`${pageName}pageContainerRoute${i}route`} path={`/${pageName}`} element={<Page setDropDownActive={setDropDownActive} dropDownActive={dropDownActive} key={`${pageName}pageContainerRoute${i}`} link={link} content={content} title={title} noDropDown={noDropDown} active={active} pageName={pageName} setActive={setActive} images={pageImages}/>} />
          ))}
          {data.projects.map(({dropdownContent, projectName, projectLink, projectImages}, i)=>(
            <Route key={`${projectName}projectContainerRoute${i}`} path={projectLink} element={<Project from={location.pathname} setDropDownActive={setDropDownActive} dropDownActive={dropDownActive} key={`projectNumber${i}`} content={dropdownContent} title={projectName} projectImages={projectImages} />} />
          )
          )}
          <Route path={`/About`} element={<About />} />
          <Route path="/" element={<Page setDropDownActive={setDropDownActive} dropDownActive={dropDownActive} key={`home`} active={active} pageName={'/'} link={link} content={content} title={title} setActive={setActive} images={images} />} />
        </Routes>
      </div>
    )
}
